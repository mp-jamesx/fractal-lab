...
dialog.addEventListener('close', () => { selected = null; detailControls?.dispose(); detailControls = null; document.body.classList.remove('detail-open'); dirty = true; });
...
if (import.meta.hot) import.meta.hot.dispose(() => {
  ...
  detailControls?.dispose(); dialog.close(); renderer.dispose(); renderer.domElement.remove();
});
